...
(function($) {
  ...
  $.flexslider.defaults = {
    ...
    prevText: '<i class="fa fa-arrow-circle-left"></i>', //String: Set the text for the "previous" directionNav item
    nextText: '<i class="fa fa-arrow-circle-right"></i>', //String: Set the text for the "next" directionNav item
